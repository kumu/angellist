...
blueprint =
    ...
    perspectives:
        'Base': [
            ...
            {collection: 'elements', selector: 'market', declarations: {imageUrl: 'assets/images/market-scope.png'}}
            {collection: 'elements', selector: 'location', declarations: {imageUrl: 'assets/images/location.png'}}
